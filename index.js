...
function moveEnemy(car){
    ...
    enemy.forEach(function(item){
        ...
        if(item.y >= 600){
            ...
            if(num==1){
                item.style.backgroundImage = "url('/images/other/oth1.png')";
            }
            if(num==2){
                item.style.backgroundImage = "url('/images/other/oth2.png')";
            }
            if(num==3){
                item.style.backgroundImage = "url('/images/other/oth3.png')";
            }
        }
...
function start(){
    ...
    for(i=0;i<3;i++){
        ...
        // el.url = car1;
        if(num==1){
            enemyCar.style.backgroundImage = "url('/images/other/oth1.png')";
        }
        if(num==2){
            enemyCar.style.backgroundImage = "url('/images/other/oth2.png')";
        }
        if(num==3){
